...
export const scenarioPresets: Array<{
...
}> = [
  {
    ...
    description: "Balanced assumptions for a mid-career saver.",
    input: {
      currentAge: 35,
      retirementAge: 65,
      lifeExpectancy: 92,
  ...
  },
  {
    id: "late-catch-up",
    label: "Late Catch-Up",
    description: "Shorter runway with a more aggressive savings rate.",
    input: {
      currentAge: 48,
      retirementAge: 67,
      lifeExpectancy: 90,
  ...
  },
  {
    id: "coast-fire",
    label: "Coast FIRE",
    description: "Higher starting assets and lighter ongoing savings.",
    input: {
      currentAge: 40,
      retirementAge: 60,
      lifeExpectancy: 95,
      ...
      withdrawalFrequency: "monthly",
      inflationRate: 0.025,
      annualWithdrawalIncrease: 0.015,
    },
  },
];
